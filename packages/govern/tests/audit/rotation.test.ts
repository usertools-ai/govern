...
describe("Audit Rotation — writeReceipt error paths", () => {
	...
	beforeEach(() => {
		tempDir = mkdtempSync(join(tmpdir(), "govern-rotation-err-"));
	});
...
describe("Audit Rotation — listReceipts edge cases", () => {
	...
	beforeEach(() => {
		tempDir = mkdtempSync(join(tmpdir(), "govern-rotation-list-edge-"));
	});
...
describe("Audit Rotation — loadIndex edge cases", () => {
	...
	beforeEach(() => {
		tempDir = mkdtempSync(join(tmpdir(), "govern-rotation-index-edge-"));
	});
