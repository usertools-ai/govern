					...
					<div className="flex flex-col gap-5">
						...
						<ScrollReveal delay={0.2}>
							<p className="text-base text-white/60 leading-relaxed">
								...
								<code className="font-mono text-ut text-sm">trust()</code> adds
								budget holds and audit trails on top — nothing changes except
						...
						<ScrollReveal delay={0.3}>
							<ul className="flex flex-col gap-3 mt-2">
								<li className="flex items-start gap-3 text-sm text-white/60">
									...
									One{" "}
									<code className="font-mono text-ut text-xs">
										await trust(client)
									</code>{" "}
								...
								<li className="flex items-start gap-3 text-sm text-white/60">
									...
									<code className="font-mono text-ut text-xs">receipt</code>{" "}
									with hash-chained proof
								</li>
							</ul>
						</ScrollReveal>
					</div>
						...
						>
							...
							<pre className="p-5 text-sm font-mono leading-relaxed overflow-x-auto">
								<code>
									...
									{"\n"}
									<span className="text-mem">const</span>{" "}
									<span className="text-white">client</span>{" "}
									<span className="text-white">=</span>{" "}
									<span className="text-mem">await</span>{" "}
									...
									<span className="text-white">:</span>{" "}
									<span className="text-ut">{'"user"'}</span>
									<span className="text-white">,</span>{" "}
									<span className="text-white">content</span>
									<span className="text-white">:</span>{" "}
									<span className="text-ut">{'"Hello"'}</span>{" "}
									<span className="text-white">{"}]"}</span>
									{"\n"}
									<span className="text-white">{"})"}</span>
									{"\n\n"}
